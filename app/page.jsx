...
export default function Home() {
  ...
  useEffect(() => {
    // عندما تدخل الصفحة، نبدأ الأنيميشن الكبير
    const sequence = async () => {
      await controls.start({
        y: [ -200, 0, -20, 0 ], // السقوط والارتداد
        rotate: [ 0, 0, 2, -2, 0 ],
        transition: {
          duration: 1.8,
          ease: "easeOut",
      ...
      // بعد الارتطام نعمل اهتزاز بسيط للشاشة كلها
  ...
  return (
    ...
    >
      <motion.div
        animate={controls}
        className="container mx-auto px-4 xl:px-0 pt-5 flex flex-col xl:flex-row items-center justify-between gap-12"
      >
        {/* النص */}
        <motion.div
          ...
          className="order-2 text-center xl:text-left xl:order-none flex-1"
        >
        ...
        <motion.div
          ...
          className="order-1 xl:order-none flex-1 flex justify-center xl:justify-end mb-8 xl:mb-0"
        >
          <Photo />
        </motion.div>
      </motion.div>
        ...
        <div className="flex flex-col xl:flex-row gap-12 justify-center">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <p className="text-white/70 mb-4">
              "كان العمل مع Haedara ممتعًا للغاية. الموقع الذي تم تطويره كان أكثر مما كنت أتوقع!"
            </p>
            <span className="text-accent-Default font-bold">أحمد المير</span>
          </div>
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <p className="text-white/70 mb-4">
              "التصميم كان مذهلاً، والواجهة سهلة الاستخدام للغاية. بالتأكيد سأعود للعمل معه مرة أخرى!"
            </p>
      ...
      <div className="text-center flex flex-col items-center mt-16 pb-10">
        ...
        <p className="text-lg text-white/70 mb-6">
          اتصل بي الآن لنبدأ في بناء موقعك الرائع!
        </p>
        <Button
          variant="outline"
          size="lg"
